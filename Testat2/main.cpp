...
//Funktionen werden deklariert damit er bei Runtime weiﬂ dass es Sie gibt
...
//Funktionen die die Basics ¸ber Arrays vermitteln
...
//Funktionen die Prim‰r mit Strings arbeiten
...
void fillArrayWithText(string stringArray[], int length) {
	...
	do {
		...
		getline(cin, eingabe); // Nutze getline f¸r die Eingabe
...
int fakultaet(int n) {
	// Basisfall: wenn n gleich 0 ist, ist die Fakult‰t 1
	if (n == 0) {
		return 1;
	}
	else {
